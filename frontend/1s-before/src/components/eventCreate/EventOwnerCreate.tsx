  ...
  return (
    <>
      <div className='flex flex-row space-x-4'>
        <span className='bg-mainColor1 px-[12px] py-[5px] rounded-full text-white'>2</span>
      ...
      <div className='flex items-center space-x-10'>
        ...
        <div className='flex-1 space-y-4'>
          ...
          <div>
            <label htmlFor='snsLink' className='block text-sm font-medium text-gray-700 mb-2'>
              SNS 링크
            </label>
            <input
              type='url'
      ...
      <div className='space-y-2'>
        <div className='flex flex-row justify-between items-center'>
          <label htmlFor='creatorIntroduce' className='block text-sm font-medium text-gray-700'>
            소개글
          </label>
        ...
        <div className='border p-2 rounded'>
          <Tiptap value={ownerData.creatorIntroduce} onChange={handleEditorChange} />
        </div>
      </div>
    </>
  );
